...
describe 'compiled component asg-v2' do
  ...
  context "Resource" do
    ...
    context "ScaleDownAlarm" do
      ...
      it "to have property Threshold" do
          expect(resource["Properties"]["Threshold"]).to eq("30")
      end
    ...
    context "ScaleUpPolicy" do
      ...
      it "to have property StepAdjustments" do
          expect(resource["Properties"]["StepAdjustments"]).to eq([{"MetricIntervalLowerBound"=>0, "MetricIntervalUpperBound"=>15, "ScalingAdjustment"=>1}, {"MetricIntervalLowerBound"=>15, "MetricIntervalUpperBound"=>25, "ScalingAdjustment"=>2}, {"MetricIntervalLowerBound"=>25, "ScalingAdjustment"=>3}])
      end
      
      it "to have property EstimatedInstanceWarmup" do
          expect(resource["Properties"]["EstimatedInstanceWarmup"]).to eq(120)
      end
